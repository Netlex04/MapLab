/* @ts-self-types="./ecu_parser.d.ts" */

export class ECUParser {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ECUParserFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_ecuparser_free(ptr, 0);
    }
    /**
    ...
    checksum() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.ecuparser_checksum(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    extract_maps() {
        const ret = wasm.ecuparser_extract_maps(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     * @param {any} definitions_js
     * @returns {any}
     */
    extract_maps_from_definitions(definitions_js) {
        const ret = wasm.ecuparser_extract_maps_from_definitions(this.__wbg_ptr, definitions_js);
        return ret;
    }
    /**
     * Byte-level diff: returns changed byte ranges as [{offset, length}] JSON.
     * @param {ECUParser} other
     * @returns {any}
     */
    fast_diff(other) {
        _assertClass(other, ECUParser);
        const ret = wasm.ecuparser_fast_diff(this.__wbg_ptr, other.__wbg_ptr);
        return ret;
    }
    /**
     ...
     * @returns {any}
     */
    get_hex_slice(offset, length) {
        const ret = wasm.ecuparser_get_hex_slice(this.__wbg_ptr, offset, length);
        return ret;
    }
    /**
    ...
    constructor(buffer, format) {
        ...
        const ret = wasm.ecuparser_new(ptr0, len0, ptr1, len1);
        this.__wbg_ptr = ret;
        ECUParserFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     * @returns {Uint8Array}
     */
    write_map_values(map_id, values) {
        const ptr0 = passStringToWasm0(map_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.ecuparser_write_map_values(this.__wbg_ptr, ptr0, len0, values);
        var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v2;
    }
}
if (Symbol.dispose) ECUParser.prototype[Symbol.dispose] = ECUParser.prototype.free;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./ecu_parser_bg.js": import0,
    };
}

const ECUParserFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_ecuparser_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('ecu_parser_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
